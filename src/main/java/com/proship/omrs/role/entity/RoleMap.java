...
public class RoleMap implements InitializingBean{
    ...
    private static BiMap<Long,String> roleTypes;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        for (Role role: list){
            roleTypes.put(role.getId(),role.getName());
        }
    ...
    public static String getRoleType(Long id){
        return roleTypes.get(id);
    }

    public static Long getRoleId(String role){
        return roleTypes.inverse().get(role);
    }
}
